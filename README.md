...
You can utilize the following Jupyter Notebook to reproduce the results presented in the paper: [TIME-CAR](https://github.com/marti5ini/time-car/blob/master/time-car.ipynb)
